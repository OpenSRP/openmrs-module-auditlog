...
<div class="box">
    ...
    <table id="${moduleId}" width="100%" cellpadding="3" cellspacing="0" align="left">
        ...
        <tr>
            ...
            <th class="ui-state-default"><spring:message code="${moduleId}.item"/> (<spring:message
                    code="${moduleId}.numberOfAssociatedAuditLogs"/>)
            </th>
            <th class="ui-state-default"><spring:message code="${moduleId}.activity"/></th>
        ...
        <c:forEach items="${auditLogs}" var="auditLog">
            <tr class="${moduleId}_${auditLog.action}" onclick="${moduleId}_showDetails('${auditLog.uuid}')">
                ...
                <td>
                    <c:if test="${fn:trim(auditLog.action) != ''}">${auditLog.action}</c:if>
                </td>
                <td>
                    <c:choose>
                        ...
                        <c:otherwise>
                            ${auditLog.user.personName} <c:if
                                test="${fn:trim(auditLog.user.username) != ''}">[${auditLog.user.username}]</c:if>
                        </c:otherwise>
                    </c:choose>
                </td>
...
<div id="${moduleId}-changes-dialog" class="${moduleId}_align_text_left"
     title="<spring:message code="${moduleId}.logDetails" />">
    <br/>
    <table id="${moduleId}-details" width="100%" cellpadding="0" cellspacing="5">
        ...
        <tr class="${moduleId}-changes-element">
            <td valign="top" colspan="2" class="${moduleId}_align_text_left">
                <table id="${moduleId}-changes-table" width="100%" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
                ...
                <table id="${moduleId}-delete-otherData-table" width="100%" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
        ...
        <tr class="${moduleId}-childAuditLogDetails-element">
            <td valign="top" colspan="2" class="${moduleId}_align_text_left">
                <table id="${moduleId}-childAuditLogDetails-table" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
...
<div id="${moduleId}-child-changes-dialog" class="${moduleId}_align_text_left"
     title="<spring:message code="${moduleId}.associatedLogDetails" />">
    <br/>
    <table id="${moduleId}-child-details" width="100%" cellpadding="0" cellspacing="5">
        ...
        <tr class="${moduleId}-changes-element">
            <td valign="top" colspan="2" class="${moduleId}_align_text_left">
                <table id="${moduleId}-child-changes-table" width="100%" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
                        <td class="${moduleId}_table_header ${moduleId}_align_text_center" width="26%">
                ...
                <table id="${moduleId}-child-delete-otherData-table" width="100%" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
                        <td class="${moduleId}_table_header ${moduleId}_align_text_center">
        ...
        <tr class="${moduleId}-childAuditLogDetails-element">
            <td valign="top" colspan="2" class="${moduleId}_align_text_left">
                <table id="${moduleId}-child-childAuditLogDetails-table" cellpadding="3" cellspacing="0" border="1"
                       bordercolor="#ADACAC">
                    <thead>
                    <tr>
                        <td class="${moduleId}_table_header ${moduleId}_align_text_left">
